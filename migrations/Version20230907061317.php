 ...
 */
final class Version20230907061317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_835033F88F93B6FC ON genre');
        $this->addSql('ALTER TABLE genre DROP movie_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genre ADD movie_id INT NOT NULL');
